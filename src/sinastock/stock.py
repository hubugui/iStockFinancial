...
def stock_url(code, year):
	return 'http://money.finance.sina.com.cn/corp/go.php/vFD_FinancialGuideLine/stockid/%s/ctrl/%s/displaytype/4.phtml'%(code, year)

def stock_pull(code, year, values):
	# http
	req = urllib2.Request(stock_url(code, year))
